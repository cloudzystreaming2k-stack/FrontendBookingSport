              ...
              <div className="flex flex-col md:flex-row items-center justify-between gap-4 w-full">
                <div className="flex items-center text-[15px] mr-auto">
                  <span className="font-extrabold text-[#111827] mr-1">{filteredCourts.length} kết quả</span> 
                    {/* <span className="text-[#8daab9] mx-1.5 flex items-center font-bold">
                      A
                    </span>  */}
                  <span className="font-medium text-[#1a769d] flex items-center gap-1 cursor-pointer hover:underline">
