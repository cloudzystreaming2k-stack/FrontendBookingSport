...
import { UserItem, UsersResponse, CreateUserForm, UpdateUserForm, defaultCreateUserForm, defaultUpdateUserForm } from "./user";
...
export function AdminUsers() {
   ...
   const [editForm, setEditForm] = useState<UpdateUserForm>(defaultUpdateUserForm);
   ...
   const handleUpdate = async () => {
      ...
      setIsUpdating(true);
      try {
         await userService.updateUser(editTarget._id, editForm);
